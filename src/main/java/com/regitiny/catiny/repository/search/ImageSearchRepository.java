...
class ImageSearchRepositoryInternalImpl implements ImageSearchRepositoryInternal {
  ...
  ImageSearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate) {
  ...
  public Page<Image> search(String query, Pageable pageable) {
    ...
    List<Image> hits = elasticsearchTemplate
      .search(nativeSearchQuery, Image.class)
