...
@RestController
@RequestMapping("/api/catiny-kafka")
@GeneratedByJHipster
public class CatinyKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CatinyKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CatinyKafkaResource(KafkaProperties kafkaProperties) {
