  ...
  const headerTop = () =>
    <>
      <div className='nav-top'>
        <Link to='/'><i className='feather-zap text-success display2-size me-3 ms-0' />
            ...
            <div className='nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2'>
              ...
              <ul className='mb-3'>
                <li><Link to='/defaultemailbox' className='nav-content-bttn open-font'><i
                  className='font-xl text-current feather-inbox me-3' /><span>Email Box</span><span
                  className='circle-count bg-warning mt-1'>584</span></Link></li>
                <li><Link to='/defaulthotel' className='nav-content-bttn open-font'>
                  <i className='font-xl text-current feather-home me-3' /><span>Near Hotel</span></Link>
                </li>
                <li><Link to='/defaultevent' className='nav-content-bttn open-font'><i
                  className='font-xl text-current feather-map-pin me-3' /><span>Latest Event</span></Link></li>
                <li><Link to='/defaultlive' className='nav-content-bttn open-font'><i
                  className='font-xl text-current feather-youtube me-3' /><span>Live Stream</span></Link></li>
              </ul>
            </div>
