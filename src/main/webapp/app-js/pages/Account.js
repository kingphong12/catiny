          ...
          <div className="middle-wrap">
            <div className="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
              <div className='card-body p-4 w-100 bg-current border-0 d-flex rounded-3'>
                <Link to='/defaultsettings' className='d-inline-block mt-2'><i className='ti-arrow-left font-sm text-white' /></Link>
                ...
                <div className='row justify-content-center'>
                  <div className='col-lg-4 text-center'>
                    <figure className='avatar ms-auto me-auto mb-0 mt-2 w100'>
                      <img src='https://via.placeholder.com/300x300.png' alt='avater' className='shadow-sm rounded-3 w-100' /></figure>
                ...
                <form action="#">
                  ...
                  <div className="row">
                    ...
                    <div className='col-lg-12 mb-3'>
                      ...
                      <textarea className='form-control mb-0 p-3 h100 bg-greylight lh-16' rows='5' placeholder='Write your message...' />
                    </div>
