                    ...
                    <div className='card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3'>
                      <div className='card-body d-block w-100 p-4 text-center'>
                        <figure className='avatar ms-auto me-auto mb-0 position-relative w90 z-index-1'>\
                          <img src={`assets/images/${value.imageUrl}`}
                               alt='avater'
                        ...
                        <ul className='d-flex align-items-center justify-content-center mt-1'>
                          <li className='m-2'><h4 className='fw-700 font-sm'>{value.connections} <span
                            className='font-xsssss fw-500 mt-1 text-grey-500 d-block'>Connections</span></h4></li>
                          <li className='m-2'><h4 className='fw-700 font-sm'>{value.follower} <span
                            className='font-xsssss fw-500 mt-1 text-grey-500 d-block'>Follower</span></h4></li>
                          <li className='m-2'><h4 className='fw-700 font-sm'>{value.following} <span
                            className='font-xsssss fw-500 mt-1 text-grey-500 d-block'>Followings</span></h4></li>
                        </ul>
                        <ul className='d-flex align-items-center justify-content-center mt-1'>
