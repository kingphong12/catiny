                ...
                <div className="col-lg-12 mb-3">
                  <div className="card p-md-5 p-4 bg-primary-gradiant rounded-3 shadow-xss bg-pattern border-0 overflow-hidden">
                    ...
                    <h2 className="display2-size display2-md-size fw-700 text-white mb-0 mt-0">Checkout <span
                      className="fw-700 ls-3 text-grey-200 font-xsssss mt-2 d-block">4 PRODUCT FOUND</span></h2>
                  </div>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-sm-12">
                  <div className="card bg-greyblue border-0 p-4 mb-5">
                    <p className="mb-0 mont-font font-xssss text-uppercase fw-600 text-grey-500"><i
                      className="fa fa-exclamation-circle"></i> Have A Coupon? <a className="expand-btn text-grey-500 fw-700"
                                                                                  href="/checkoutcoupon_info">Click Here To Enter
                      Your Code.</a></p>
                  </div>
                </div>
                ...
                <div className="col-xl-6 col-lg-6">
                  <div className="page-title">
                    ...
                    <div className="form-check text-left mb-3 mt-2">
                      ...
                      <label className="pt--1 form-check-label fw-600 font-xsss text-grey-700">Ship to a different address
                        ?</label>
                    </div>
                ...
                <div className="col-xl-5 offset-xl-1 col-lg-6">
                  <div className="order-details">
                    ...
                    <div className="table-content table-responsive mb-5 card border-0 bg-greyblue p-lg-5 p-4">
                      <table className="table order-table order-table-2 mb-0">
                        ...
                        <tr className="order-total">
                          <th>Order Total</th>
                          <td className="text-right text-grey-700 font-xsss fw-700"><span
                            className="order-total-ammount">$56.00</span></td>
                        </tr>
                        </tfoot>
                      </table>
                    </div>
                      ...
                      <form action="#" className="payment-form">
                        <div className="payment-group mb-4">
                          ...
                          <div className="payment-info" data-method="bank">
                            <p className="font-xssss lh-24 text-grey-500 ps-4">Make your payment directly into our bank account.
                        ...
                        <div className="payment-group mb-4">
                          ...
                          <div className="payment-info cheque hide-in-default" data-method="cheque">
                            <p className="font-xssss lh-24 text-grey-500 ps-4">Please send a check to Store Name, Store Street,
                    ...
                    <div className="card shadow-none border-0">
                      <a href="/checkout"
                         className="w-100 p-3 mt-3 font-xsss text-center text-white bg-current rounded-3 text-uppercase fw-600 ls-3">Place
                        Order</a>
                    </div>
