              ...
              <div className="chat-wrapper p-0 w-100 position-relative scroll-bar bg-white theme-dark-bg">
                      ...
                      <AccordionItem className="shadow-none mb-0 p-0 bg-transparent">
                        <AccordionItemHeading className="card-header ps-0 pt-0 pb-2 pe-0 bg-transparent">
                          <AccordionItemButton className="d-flex">
                            <figure className="avatar me-2 mb-0 w35 mt-1 pt-1"><img src="assets/images/user.png"
                                                                                    alt="avater"
                        ...
                        <AccordionItemPanel className="card-body p-0">
                          <p className="text-grey-600 mb-4 font-xsss lh-28 fw-500 mt-3 text-dark">Hi Aenni, <br/>
                            <br/> All individual Framer subscriptions have been grandfathered into a Pro plan at your
                            existing rate. If you were on a Small Team plan, then all 5 seats have been converted over
                            to Pro seats at your existing rate. <br/><br/> Regards,<br/>Jessica </p>
                          <textarea className="form-control mb-5 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Write your message..."/>
                        </AccordionItemPanel>
                      </AccordionItem>
                      <AccordionItem className="shadow-none mb-0 p-0 bg-transparent">
                        <AccordionItemHeading className="card-header ps-0 pt-0 pb-2 pe-0 bg-transparent">
                ...
                <div className="chat-bottom dark-bg p-3 mb-3 border-top border-bottom bor-0 theme-dark-bg" style={{width: '98%'}}>
                  <form className="chat-form d-block overflow-hidden">
                    <button className="bg-dark border-0 btn-round-md float-left d-lg-block d-none"><i
                      className="ti-microphone text-white lh-4 font-xs"/></button>
                    <button className="bg-dark border-0 btn-round-md ms-1 float-left"><i className="ti-clip text-white lh-4 font-xs"/></button>
                    <button className="bg-dark border-0 btn-round-md ms-1 float-left"><i className="ti-image text-white lh-4 font-xs"/>
                    </button>
