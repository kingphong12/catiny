              ...
              <div key={index} className="col-lg-4 col-md-6 pe-2 ps-2">
                <div className="card p-3 bg-white w-100 hover-card border-0 shadow-xss rounded-xxl border-0 mb-3 overflow-hidden ">
                  ...
                  <div className='card-body d-flex ps-0 pe-0 pb-0'>
                    <div className='bg-greylight me-3 p-3 border-light-md rounded-xxl theme-dark-bg'><h4
                      className='fw-700 font-lg ls-3 text-grey-900 mb-0'><span
                      className='ls-3 d-block font-xsss text-grey-500 fw-500'>{value.month}</span>{value.date}</h4></div>
                    <h2 className='fw-700 lh-3 font-xss'>{value.title}
                      <span className='d-flex font-xssss fw-500 mt-2 lh-3 text-grey-500'> <i
                  ...
                  <div className='card-body p-0'>
                    <ul className='memberlist mt-4 mb-2 ms-0 d-inline-block'>
                      ...
                      <li className='last-member'>
                        <a href='/defaultevent' className='bg-greylight fw-600 text-grey-500 font-xssss ls-3 text-center'>+2</a></li>
                    </ul>
                    <a href='/defaultevent'
