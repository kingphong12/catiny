            ...
            <div className="row">
              <div className="col-xl-6 chat-left scroll-bar">
                ...
                {jobList.map((value, index) => (
                  ...
                  <div key={index} className="card d-block w-100 border-0 mb-3 shadow-xss bg-white rounded-3 pe-4 pt-4 pb-4"
                    ...
                    <h4 className="font-xss fw-700 text-grey-900 mb-3 pe-4">{value.title} <span
                      className="font-xssss fw-500 text-grey-500 ms-4">({value.date})</span></h4>
                    <h5 className="font-xssss mb-2 text-grey-500 fw-600"><span
                      className="text-grey-900 font-xssss text-dark">Location : </span> {value.employment}</h5>
                    <h5 className="font-xssss mb-2 text-grey-500 fw-600"><span
                      className="text-grey-900 font-xssss text-dark">Employment : </span>{value.salary}</h5>
                    <h5 className="font-xssss text-grey-500 fw-600 mb-3"><span
                      className="text-grey-900 font-xssss text-dark">Salary : </span> {value.following}</h5>
                    ...
                    <a href="/defaultjob" className="position-absolute bottom-15 mb-3 right-15"><i
