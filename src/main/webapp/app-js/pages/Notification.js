            ...
            <div className="col-lg-12">
              <div className="chat-wrapper p-3 w-100 position-relative scroll-bar bg-white theme-dark-bg">
                <h2 className="fw-700 mb-4 mt-2 font-md text-grey-900 d-flex align-items-center">Notification
                  ...
                  <a href="/defaultnotification" className="ms-auto btn-round-sm bg-greylight rounded-3"><i
                  ...
                  {notiList.map((value, index) => (
                    <li key={index}>
                      <a href="/defaultnotification" className={`d-flex align-items-center p-3 rounded-3 ${value.read}`}>
                        ...
                        <h6 className="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>{value.name}</strong> posted in
                          : {value.des}<span className="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 0l-auto"> {value.time}</span></h6>
