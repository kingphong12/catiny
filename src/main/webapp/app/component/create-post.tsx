  ...
  return (
    <div className='card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3'>
      ...
      <div className='card-body p-0 mt-3 position-relative'>
        <figure className='avatar position-absolute ms-2 mt-1 top-5'><img src='assets/images/user.png' alt='icon'
                                                                          className='shadow-sm rounded-circle w30' /></figure>
        <textarea name='message' className='h100 bor-0 w-100 rounded-xxl p-2 ps-5 font-xssss text-grey-500 fw-500 border-light-md theme-dark-bg'
                  cols={30} rows={10} placeholder="What's on your mind?" />
      </div>
      <div className='card-body d-flex p-0 mt-0'>
        <a href='#video' className='d-flex align-items-center font-xssss fw-600 ls-1 text-grey-700 text-dark pe-4'><i
          className='font-md text-danger feather-video me-2' /><span className='d-none-xs'>Live Video</span></a>
        <a href='#photo' className='d-flex align-items-center font-xssss fw-600 ls-1 text-grey-700 text-dark pe-4'><i
          className='font-md text-success feather-image me-2' /><span className='d-none-xs'>Photo/Video</span></a>
        <a href='#activity' className='d-flex align-items-center font-xssss fw-600 ls-1 text-grey-700 text-dark pe-4'><i
          className='font-md text-warning feather-camera me-2' /><span className='d-none-xs'>Feeling/Activity</span></a>
