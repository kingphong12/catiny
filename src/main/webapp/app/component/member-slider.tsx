      ...
      {memberList.map((value, index) => (
        <div key={index} className='card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-3'>
          ...
          <div className='card-body d-block w-100 ps-4 pe-4 pb-4 text-center'>
            <figure className='avatar overflow-hidden ms-auto me-auto mb-0 mt--6 position-relative w75 z-index-1'><img
              src={`assets/images/${value.imageUrl}`} alt='avater' className='float-right p-1 bg-white rounded-circle w-100' /></figure>
