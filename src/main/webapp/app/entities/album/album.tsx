...
export const Album = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const links = useAppSelector(state => state.album.links);
  const entity = useAppSelector(state => state.album.entity);
  ...
  return (
    <div>
      <h2 id="album-heading" data-cy="AlbumHeading">
        <Translate contentKey="catinyApp.album.home.title">Albums</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="catinyApp.album.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="catinyApp.album.home.createLabel">Create new Album</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('catinyApp.album.home.search')}
                />
          ...
          {albumList && albumList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="catinyApp.album.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('uuid')}>
                    <Translate contentKey="catinyApp.album.uuid">Uuid</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="catinyApp.album.home.notFound">No Albums found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
