              ...
              <li key={index} className='bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center'>
                ...
                <h3 className='fw-700 mb-0 mt-0'>
                    <span className='font-xssss text-grey-600 d-block text-dark model-popup-chat pointer'
                          onClick={toggleOpen}>{value.name}</span>
                </h3>
        ...
        <div className='section full pe-3 ps-4 pt-4 pb-4 position-relative feed-body'>
          ...
          <ul className='list-group list-group-flush'>
            <li className='bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center'>
              ...
              <h3 className='fw-700 mb-0 mt-0'>
                  <span className='font-xssss text-grey-600 d-block text-dark model-popup-chat pointer'
                        onClick={toggleOpen}>Studio Express</span>
              </h3>
        ...
        <div className='modal-popup-wrap bg-white p-0 shadow-lg rounded-3'>
          <div className='modal-popup-header w-100 border-bottom'>
            <div className='card p-3 d-block border-0 d-block'>
              ...
              <h4 className='text-grey-500 font-xsssss mt-0 mb-0'><span className='d-inline-block bg-success btn-round-xss m-0'></span> Available
              </h4>
              <div className='font-xssss position-absolute right-0 top-0 mt-3 me-4 pointer' onClick={
                toggleOpen
              }><i className='ti-close text-grey-900 mt-2 d-inline-block'></i></div>
            </div>
          </div>
            ...
            <div className='card p-3 d-block border-0 d-block'>
              <div className='form-group icon-right-input style1-input mb-0'>
                <input type='text' placeholder='Start typing..'
                       className='form-control rounded-xl bg-greylight border-0 font-xssss fw-500 ps-3' /><i
                className='feather-send text-grey-500 font-md'></i></div>
            </div>
          </div>
        </div>
      </div>
