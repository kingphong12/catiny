...
export default class PageProfileUpdatePage {
  pageTitle: ElementFinder = element(by.id('catinyApp.pageProfile.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  uuidInput: ElementFinder = element(by.css('input#page-profile-uuid'));
  infoSelect: ElementFinder = element(by.css('select#page-profile-info'));
